            ...
            <div class="col-lg-12 col-md-12 col-12">
                ...
                <div class="border-bottom pb-4 mb-4 d-lg-flex align-items-center justify-content-between">
                    <div class="mb-2 mb-lg-0">
                        <h1 class="mb-0 h2 fw-bold mb-3">جوازات إنتهت </h1>
                        <!-- Breadcrumb -->
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">      جوازات إنتهت ({{$upcomingVisaPasspor->count() + $upcomingAccommodationPasspor->count() }})    </li>
                            </ol>
                        </nav>
                    </div>
                                    ...
                                    <table id="dt-filter-search" class="table table-hover table-row-bordered  border rounded">
                                        ...
                                        @foreach ($upcomingVisaPasspor as $key => $visas)
                                            ...
                                            @endphp
                                                <tr>
                                                    ...
                                                    <td  class="passpor_end" style="color: red"><b>{{ now()->parse($visas->passpor_end)->format('Y/m/d') }}</b></td>
                                                    <td  style="color: red"><b>{{ now()->diffInDays($visas->passpor_end) }} يوم </b></td>
                                                    <td>

                                                        <a href="{{route('ExtensionPassporvEnd',$visas->slug)}}" class=" text-muted text-primary-hover texttooltip" data-template="one">
                                        ...
                                        @foreach ($upcomingAccommodationPasspor as $key => $Accommodations)
                                            ...
                                            <tr>
                                                ...
                                                <td  class="passpor_end" style="color: red"><b>{{ now()->parse($Accommodations->passpor_end)->format('Y/m/d') }}</b></td>
                                                <td  style="color: red"><b>{{ now()->diffInDays($Accommodations->passpor_end) }} يوم </b></td>
                                                <td class="dob" hidden="hidden">{{ now()->diffInYears($Accommodations->dob)  }} سنه</td>
                                                <td>

                                                    <a href="{{route('ExtensionPassporaEnd',$Accommodations->slug)}}" class=" text-muted text-primary-hover texttooltip" data-template="one">
                                                        <i class="fe fe-edit fs-3"  data-bs-toggle="offcanvas" data-bs-target="#offcanvasRightEdit" ></i>
                                                    </a>
                                                </td>
                                                <td>
