            ...
            <div class="col-lg-12 col-md-12 col-12">
                ...
                <div class="border-bottom pb-4 mb-4 d-lg-flex align-items-center justify-content-between">
                    <div class="mb-2 mb-lg-0">
                        <h1 class="mb-0 h2 fw-bold mb-3">تأشيرات إنتهت </h1>
                        <!-- Breadcrumb -->
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">      تأشيرات إنتهت ({{$upcomingVisas->count() }})    </li>
                            </ol>
                        </nav>
                    </div>
                                ...
                                <table id="dt-filter-search" class="table table-hover table-row-bordered  border rounded">
                                        ...
                                        @foreach ($upcomingVisas as $key => $visas)
                                            ...
                                            <tr>
                                                ...
                                                <td class="visa_end" style="color: red"><b>{{ now()->parse($visas->visa_end)->format('Y/m/d') }}</b></td>
                                                <td style="color: red"><b>{{ now()->diffInDays($visas->visa_end) }} يوم</b></td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{route('ExtensionVisaEnd',$visas->slug)}}" class=" text-muted text-primary-hover texttooltip" data-template="one">
