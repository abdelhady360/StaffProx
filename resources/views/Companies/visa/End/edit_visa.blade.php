    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-12">
            ...
            <div class="border-bottom pb-4 mb-4 d-lg-flex align-items-center justify-content-between">
                <div class="mb-2 mb-lg-0">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{url('AllVisaEnd')}}">تأشيرات إنتهت</a>
                            </li>
                ...
                <div class="d-flex align-items-center">
                    <!-- button -->
                    <a href="{{url('AllVisaEnd')}}" class="btn btn-primary me-2"> الرجوع للخلف  <i class="fa-solid fa-angles-left"></i></a>
        ...
        <div class="row">
            <div class="offset-xl-3 col-xl-6 col-12">
                ...
                <!-- card -->
                <form action="{{route('UpdateVisaEnd',$Visa->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('post')
                    <div class="card mb-4">
                        <!-- card body -->
