...
@section('title')
    بالوصية ضمان قارب علي انتهائها 30 يوم
@stop
@section('content')
            ...
            <div class="col-lg-12 col-md-12 col-12">
                ...
                <div class="border-bottom pb-4 mb-4 d-lg-flex align-items-center justify-content-between">
                    <div class="mb-2 mb-lg-0">
                        <h1 class="mb-0 h2 fw-bold mb-3">بالوصية ضمان قارب علي انتهائها 30 يوم </h1>
                        <!-- Breadcrumb -->
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">      بالوصية ضمان قارب علي انتهائها 30 يوم ({{$upcomingInsurance->count() }})    </li>
                            </ol>
                        </nav>
                    </div>
                                        ...
                                        @foreach ($upcomingInsurance as $key => $insurances)
                                            ...
                                            @endphp
                                                <tr>
                                                    ...
                                                    <td class="name" style="color: {{$ColorInsuranceEnd}}"><b>{{$insurances->insurance_end}}</b></td>
                                                    <td style="color: {{$ColorInsuranceEnd}}"><b>{{ now()->diffInDays($insurances->insurance_end) }} يوم </b></td>
