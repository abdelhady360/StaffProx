            ...
            <div class="col-lg-12 col-md-12 col-12">
                ...
                <div class="border-bottom pb-4 mb-4 d-lg-flex align-items-center justify-content-between">
                    <div class="mb-2 mb-lg-0">
                        <h1 class="mb-0 h2 fw-bold mb-3">جميع الاشكال القانونية </h1>
                        <!-- Breadcrumb -->
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">      جميع الاشكال القانونية ({{$LegalForm->count()}})    </li>
                            </ol>
                        </nav>
                    </div>
                    <div class="d-flex align-items-center">
                        <!-- button -->
                        <a href="#" class="btn btn-primary me-2" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" > <i class="fa-solid fa-plus"></i> إضافة شكل قانوني  </a>
                                                        ...
                                                        <div class="table-card">
                                                            <table id="dt-filter-search" class="table table-hover table-row-bordered  border rounded">
                                                                ...
                                                                <tr class="table-light">
                                                                    <th><b>الشكل القانوني</b></th>
                                                                    <th><b>تعديل</b></th>
                                                                    <th><b>حذف</b></th>
                                                                </tr>
                                                                </thead>
                                                                <tbody>
                                                                  @foreach ($LegalForm as $key => $LegalForms)
                                                                    <tr>
                                                                        <td>{{$LegalForms->name}}</td>
                                                                        <td>
                                                                            <a href="{{route('EditLegalForm',$LegalForms->slug)}}" class=" text-muted text-primary-hover texttooltip" data-template="one">
                                                                                <i class="fe fe-edit fs-3"  data-bs-toggle="offcanvas" data-bs-target="#offcanvasRightEdit" ></i>
                                                                            </a>
                                                                        </td>
                                                                        <td>
                                                                            <form method="POST" action="{{ route('DestroyLegalForm', $LegalForms->id) }}">
                                                                                @csrf
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" style="width: 600px;">
        <div class="offcanvas-body " data-simplebar >
            <div class="offcanvas-header px-2 pt-0">
                <h3 class="offcanvas-title" id="offcanvasExampleLabel">إضافة شكل قانوني</h3>
                <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
            </div>
            <form action="{{route('StoreLegalForm')}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('post')
                <!-- card body -->
                <div class="container">
                    ...
                    <div class="row" >
                        ...
                        <div class="mb-3 col-12">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="الشكل القانوني " required>
                        </div>
                        <!-- form group -->
                        <!-- form group -->
...
@section('script')
    ...
    <script type="text/javascript">
        $('.show-alert-delete-box').click(function(event){
            ...
            swal({
                title: "هل انت تريد حذف الشكل القانوني ؟",
                text: "",
                icon: "warning",
                type: "warning",
                buttons: ["رجوع","حذف !"],
