        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                ...
                <div class="border-bottom pb-4 mb-4 d-lg-flex align-items-center justify-content-between">
                    ...
                    <div>
                        <a href="{{route('StepsTransactions',$transaction->slug)}}" class="btn btn-primary me-2"> خطوات الخدمة <i class="fa-regular fa-folder">  </i>  </a>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-8 col-12">
                ...
                <div class="mb-4">
                    <div class="card">
                        <!-- card body -->
                        <div class="card-header "><h4 class="mb-0 fw-bold">  وصف الخدمة </h4></div>
                        <div class="card-body">
                            <p class="h5"> {!! $transaction->info !!}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mt-4 mt-lg-0 mb-5">
                    ...
                    <div class="card-body ">
                        <div style="width:100%;text-align:center" class="d-flex justify-content-between align-items-center ">
                            ...
                            <a style="width:100%;text-align:center" target="_blank" title="ابدأ الأن" href="{{ $transaction->url }}" class="btn center"><i class="fa-regular fa-paper-plane  fa-5x"></i></a>
                        </div>
                    </div>
                </div>
                <!-- card -->
