            ...
            <div class="col-lg-12 col-md-12 col-12">
                ...
                <div class="border-bottom pb-4 mb-4 d-lg-flex align-items-center justify-content-between">
                    <div class="mb-2 mb-lg-0">
                        <h1 class="mb-0 h2 fw-bold mb-3">جميع الإستعلامات </h1>
                        <!-- Breadcrumb -->
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">      جميع الإستعلامات ({{$research->count()}})    </li>
                            </ol>
                        </nav>
                    </div>
                    <div class="d-flex align-items-center">
                        <!-- button -->
                        <a href="{{url('AddResearchs')}}" class="btn btn-primary me-2" > <i class="fa-solid fa-plus"></i> إضافة إستعلام  </a>
                                ...
                                <div class="table-card">
                                    <table id="dt-filter-search" class="table table-hover table-row-bordered  border rounded">
                                        ...
                                        @foreach ($research as $key => $researchs)
                                            <tr>
                                                <td> <a href="{{route('WatchInfoResearch',$researchs->slug)}}" target="_blank" class="fw-bold" style="color: #64748b;"> <b> {{$researchs->name}}  </b> </a> </td>
                                                <td>
                                                    <a href="{{route('EditResearchs',$researchs->slug)}}" class=" text-muted text-primary-hover texttooltip" data-template="one">
                                                        <i class="fe fe-edit fs-3"  data-bs-toggle="offcanvas" data-bs-target="#offcanvasRightEdit" ></i>
                                                    </a>
                                                </td>
                                                <td>
                                                    <form method="POST" action="{{ route('UpdateResearchs', $researchs->id) }}">
                                                        @csrf
...
@section('script')
    ...
    <script type="text/javascript">
        $('.show-alert-delete-box').click(function(event){
            ...
            swal({
                title: "هل انت تريد حذف الإستعلام ؟",
                text: "",
                icon: "warning",
                type: "warning",
                buttons: ["رجوع","حذف !"],
