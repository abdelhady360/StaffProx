...
@section('title')
       تمديد الإقامة | {{$Accommodation->name}}
@stop
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-12">
            ...
            <div class="border-bottom pb-4 mb-4 d-lg-flex align-items-center justify-content-between">
                <div class="mb-2 mb-lg-0">
                    <h1 class="mb-0 h2 fw-bold mb-3">  تمديد الإقامة  </h1>
                    <!-- Breadcrumb -->
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{url('AllAccommodationExpired')}}">إقامات قاربت علي انتهائها 30 يوم</a>
                            </li>
                ...
                <div class="d-flex align-items-center">
                    <!-- button -->
                    <a href="{{url('AllAccommodationExpired')}}" class="btn btn-primary me-2"> الرجوع للخلف  <i class="fa-solid fa-angles-left"></i></a>
        ...
        <div class="row">
            <div class="offset-xl-3 col-xl-6 col-12">
                ...
                <!-- card -->
                <form action="{{route('UpdateAccommodationExpired',$Accommodation->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('post')
                    <div class="card mb-4">
                        <!-- card body -->
                        <div class="card-body">
                            <h4 class="mb-4 mb-5"><b>تمديد الإقامة</b></h4>
                            <!-- row -->
                            <div class="row gx-3">
                                <!-- form group -->
                                <div class="mb-6 col-md-6 col-6">
                                    ...
                                    <div class="input-group me-3">
                                        <input disabled class="form-control flatpickr fs-5 fw-bold" value="{{$Accommodation->name}}">
                                    </div>
                                </div>
                                ...
                                <div class="mb-6 col-md-6 col-6">
                                    ...
                                    <div class="input-group me-3">
                                        <input disabled class="form-control flatpickr fs-5 fw-bold" value="{{$Accommodation->companie->name}}">
                                    </div>
                                </div>
                                <!-- form group -->
