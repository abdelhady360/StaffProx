        ...
        <div class="col-lg-12 col-md-12 col-12">
            ...
            <div class="border-bottom pb-4 mb-4 d-lg-flex align-items-center justify-content-between">
                <div class="mb-2 mb-lg-0">
                    <h1 class="mb-0 h2 fw-bold mb-3">إضافة سؤال</h1>
                    <!-- Breadcrumb -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="row gx-3">
                                ...
                                <div class="mb-3 col-12">
                                    ...
                                    <input type="text" value="{{old('faq')}}" name="faq" class="form-control" placeholder=" السؤال ؟ " required>
                                </div>
                                ...
                                <div class="mb-3 col-12">
                                    ...
                                    <textarea name="info" id="editor">{{old('info')}}</textarea>
                                    <div id="editor" name="info"></div>
                                </div>
